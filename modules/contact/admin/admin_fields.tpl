...
{if $smarty.request.id != ''}
	...
	<div class="head"><h5 class="iFrames">{#CONTACT_NEW_FILED_ADD#}</h5></div>
		<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
			...
			<tr>
				<td><div class="pr12"><input placeholder="{#CONTACT_FILED_NAME#}" name="contact_field_title" type="text" id="contact_field_title" value="" /></div></td>
				<td>
			...
			<tr>
				<td colspan="2"><div class="pr12"><input placeholder="{#CONTACT_DEFAULT_VALUE#}" type="text" name="contact_field_default" value="" /></div></td>
				...
				<td colspan="3" align="center"><div class="pr12"><input placeholder="{#CONTACT_REG_STRING#}" type="text" name="contact_field_value" value="" /></div></td>
			</tr>
